...
class SimpleTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = SimpleMLPBlock(channel_dim=channel_dim, expansion=expansion, dropout=dropout, activation=activation)
        self.attn = SimpleAttention(num_heads=num_heads, channel_dim=channel_dim)
